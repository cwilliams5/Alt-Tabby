...
_INT_Alt_Up(*) {
    ...
    pendingPhase := gGUI_Pending.phase  ; PERF: cache property read (used twice)
    if (gFR_Enabled)
        FR_Record(FR_EV_ALT_UP, gINT_SessionActive, gINT_PressCount, gINT_TabPending, pendingPhase != "")
