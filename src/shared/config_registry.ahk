...
global gConfigRegistry := [
    ...
    {type: "subsection", section: "GUI", name: "Selection Shader",
     desc: "Animated shader-based selection highlight. When enabled, replaces the flat color fill with a shader effect fed SelARGB, SelBorderARGB, SelBorderWidthPx, and RowRadius from Selection Colors above. When disabled, selection uses the flat colors directly."},
    ...
    {s: "GUI", k: "SelectionDarkness", g: "GUI_SelectionDarkness", t: "float", default: 0.0,
     min: 0.0, max: 1.0,
     d: "Crush selection effect toward black without affecting transparency."},
    {s: "GUI", k: "SelectionDesaturation", g: "GUI_SelectionDesaturation", t: "float", default: 0.0,
     min: 0.0, max: 1.0,
     d: "Desaturate the selection effect toward grayscale."},
    {s: "GUI", k: "SelectionSpeed", g: "GUI_SelectionSpeed", t: "float", default: 1.0,
     min: 0.1, max: 10.0,
     d: "Animation speed multiplier for selection shaders."},
    {s: "GUI", k: "SelectionGlow", g: "GUI_SelectionGlow", t: "float", default: 1.0,
     min: 0.0, max: 3.0,
     d: "Outer glow radius multiplier. Scales how far the effect bleeds beyond the selection border."},
    ...
    {type: "subsection", section: "GUI", name: "Hover Selection Shader",
     desc: "Independent shader for hover rows. When disabled, hover reuses the selection shader at SelectionIntensityForHover. When enabled, hover gets its own shader fed HoverARGB, HovBorderARGB, HovBorderWidthPx, and RowRadius from Selection Colors."},
    ...
    {s: "MouseEffect", k: "Darkness", g: "MouseEffect_Darkness", t: "float", default: 0.0,
     min: 0.0, max: 1.0,
     d: "Darken the mouse effect. 0 = no change, 1 = fully black."},
    {s: "MouseEffect", k: "Desaturation", g: "MouseEffect_Desaturation", t: "float", default: 0.0,
     min: 0.0, max: 1.0,
     d: "Desaturate the mouse effect. 0 = full color, 1 = grayscale."},
    ...
    {s: "MouseEffect", k: "Reactivity", g: "MouseEffect_Reactivity", t: "float", default: 1.0,
     min: 0.1, max: 3.0,
     d: "How strongly the cursor disturbs the effect. Higher = more dramatic."},
    ...
    {type: "subsection", section: "BackgroundImage", name: "Layout",
     desc: "How the image is sized and positioned within the overlay."},
    {s: "BackgroundImage", k: "FitMode", g: "BGImgFitMode", t: "enum", default: "Fill",
     options: ["Fill", "Fit", "Stretch", "Tile", "Fixed"],
     d: "How the image fits the overlay. Fill = cover (may crop). Fit = contain (may letterbox). Stretch = distort to fill. Tile = repeat at natural size. Fixed = natural size, no scaling."},
    {s: "BackgroundImage", k: "Alignment", g: "BGImgAlignment", t: "enum", default: "Center",
     ...
     d: "Anchor point for Fill (crop origin), Fit (position within letterbox), and Fixed (position within overlay). Ignored for Stretch and Tile."},
    {s: "BackgroundImage", k: "Scale", g: "BGImgScale", t: "float", default: 1.0,
     min: 0.1, max: 4.0,
     d: "Image scale multiplier. Applies to Fixed and Fit modes only — other modes determine their own sizing."},
    {s: "BackgroundImage", k: "ScaleFilter", g: "BGImgScaleFilter", t: "enum", default: "Sharp",
     options: ["Sharp", "Smooth", "HighQuality"],
     d: "Rendering filter for scaled images. Sharp = pixel-perfect (nearest neighbor), best for upscaling pixel art. Smooth = bilinear, good all-around. HighQuality = bicubic, best for downscaling photos. Applies to all modes that resize the image."},

    {type: "subsection", section: "BackgroundImage", name: "Adjustments",
     desc: "Image appearance adjustments — opacity, blur, color."},
    ...
    {type: "subsection", section: "BackgroundImage", name: "Shadow",
     desc: "Drop shadow behind the image (best with transparent PNGs in Fixed/Fit mode)."},
    {s: "BackgroundImage", k: "ShadowEnabled", g: "BGImgShadowEnabled", t: "bool", default: false,
     d: "Render a drop shadow behind the image. Best with transparent PNGs. Visible in Fixed and Fit modes."},
    {s: "BackgroundImage", k: "ShadowRadius", g: "BGImgShadowRadius", t: "float", default: 10.0,
     min: 0.0, max: 50.0,
     d: "Shadow blur radius in pixels."},
    {s: "BackgroundImage", k: "ShadowOpacity", g: "BGImgShadowOpacity", t: "float", default: 0.5,
     min: 0.0, max: 1.0,
     d: "Shadow opacity. 0.0 = invisible, 1.0 = fully opaque."},
    {s: "BackgroundImage", k: "ShadowOffsetX", g: "BGImgShadowOffsetX", t: "int", default: 4,
     min: -50, max: 50,
     d: "Horizontal shadow offset in pixels."},
    {s: "BackgroundImage", k: "ShadowOffsetY", g: "BGImgShadowOffsetY", t: "int", default: 4,
     min: -50, max: 50,
     d: "Vertical shadow offset in pixels."},
