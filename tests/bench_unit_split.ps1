...
#Include $testsDir\..\src\store\windowstore.ahk
#Include $testsDir\..\src\store\winenum_lite.ahk
#Include $testsDir\..\src\store\komorebi_sub.ahk
#Include $testsDir\..\src\store\icon_pump.ahk
