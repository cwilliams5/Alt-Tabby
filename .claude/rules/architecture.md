...
- `src/lib/` - Third-party libraries (cjson, WebView2) + auto-generated shader bundles. NOT `src/shared/`.
- `src/lib/d2d_shader.ahk` - D3D11 shader pipeline (init, compile, pre-render, draw)
...
Key files: `src/lib/d2d_shader.ahk` (D3D11 pipeline), `src/gui/gui_effects.ahk` (compositor), `src/lib/shader_bundle.ahk` + `src/lib/shader_resources.ahk` (auto-generated by `tools/shader_bundle.ps1`).
